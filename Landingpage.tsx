...
const PageCard: React.FC<{ card: PageCardProps }> = ({ card }) => (
  <div className="w-[647px] h-[363px] pt-5 rounded-tl-[48px] border-t border-l border-[#016AFF] shadow-md">
...
const PricingCard: React.FC<{ plan: PricingPlanProps }> = ({ plan }) => (
  <div className={`w-[424px] h-[697px] rounded-tl-2xl border-t border-l ${plan.bgColor} p-6 flex flex-col`}>
...
const CircleDiagram: React.FC<CircleDiagramProps> = ({ title, percentage, description }) => (
  <div className="relative w-[704px] h-[704px] flex items-center justify-center">
    <div className="absolute w-full h-full border-[5px] border-[#0047FF] rounded-full"></div>
    <div className="absolute flex flex-col items-center text-center p-16">
